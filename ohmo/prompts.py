    ...
    *,
    ...
    sections.extend(
        [
            "# Calory skill",
            (
                "For questions about food, calories, weight, or participant health, "
                "nutrition, or activity (including питание, калории, вес), invoke "
                "the `calory` skill first and follow its instructions."
            ),
        ]
    )
