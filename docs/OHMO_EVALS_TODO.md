...
- [ ] P0: Rehydrate the SQLite lookup index from JSON/JSONL source of truth.
...
- [ ] P0: Detect stale review manifests before promotion.
...
- [ ] P0: Freeze the execution report schema contract.
...
- [ ] P1: Add explicit output filenames for runnable eval artifacts.
...
- [ ] P1: Add eval artifact inspection commands.
...
- [ ] P1: Improve embedding/index operations for repeated local runs.
...
- [ ] P1: Use embeddings and usage-graph signals in candidate mining.
...
- [ ] P1: Introduce an extensible scorer/judge contract for eval execution.
...
- [ ] P1: Cap resource snapshot directory aggregation.
...
- [ ] P1: Add compact runbook examples for baseline promotion.
...
- [ ] P2: Add optional machine-readable CLI summaries.
...
- [ ] P2: Revisit broader SQLite projections only if the trigger conditions in
